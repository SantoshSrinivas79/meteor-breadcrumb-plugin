...
var breadReactive = new ReactiveVar('/');
Breadcrumb = {
  getAll: function() {
  	console.log('getAll');
...
Meteor.startup(function(){
	...
	Tracker.autorun(function(){
		FlowRouter.watchPathChange();
		console.log('changing reactiveVar');
		breadReactive.set('#'+FlowRouter.current().route.name+'#');
		console.log('reactive var is now '+breadReactive.get())
	})
});
